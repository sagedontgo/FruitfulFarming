data merge entity @s {start_interpolation:-1,interpolation_duration:0,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[0.7f,0.7f,0.7f]}}

scoreboard players set @s ff.growthTimer 2400
...
scoreboard players set @s ff.age 2
scoreboard players reset $ff.randomValue
tag @s add ff.cropAge.2
tag @s add ff.aged
