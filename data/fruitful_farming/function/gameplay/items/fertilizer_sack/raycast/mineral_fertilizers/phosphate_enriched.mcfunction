...
execute anchored eyes positioned ~ ~1.5 ~ run particle block{block_state:"minecraft:bone_block"} ^ ^ ^1.5 0.2 0.1 0.2 0 10
execute anchored eyes positioned ~ ~1.5 ~ run particle block{block_state:"minecraft:quartz_block"} ^ ^ ^1.5 0.2 0.1 0.2 0 10
...
playsound minecraft:block.bone_block.break block @a[distance=..5] ~ ~ ~ 10 1
