...
execute anchored eyes positioned ~ ~1.5 ~ run particle block{block_state:"minecraft:gravel"} ^ ^ ^1.5 0.2 0.1 0.2 0 10
execute anchored eyes positioned ~ ~1.5 ~ run particle block{block_state:"minecraft:coal_block"} ^ ^ ^1.5 0.2 0.1 0.2 0 10
...
playsound minecraft:block.gravel.break block @a[distance=..5] ~ ~ ~ 10 1
