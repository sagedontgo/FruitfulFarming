...
execute anchored eyes positioned ~ ~1.5 ~ run particle block{block_state:"minecraft:gray_concrete"} ^ ^ ^1.5 0.2 0.1 0.2 0 10
execute anchored eyes positioned ~ ~1.5 ~ run particle block{block_state:"minecraft:light_gray_wool"} ^ ^ ^1.5 0.2 0.1 0.2 0 1
...
playsound minecraft:entity.creeper.hurt block @a[distance=..5] ~ ~ ~ 10 2
