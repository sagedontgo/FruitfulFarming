...
scoreboard players operation $temp ff.growthTimer *= $ff.20 ff.int
...
scoreboard players add @e[sort=nearest,limit=1,type=item_display,tag=ff.plantPlaced] ff.fertilizationLevel 25
